...
public class PulutusWalletController {
    ...
    @ResponseBody
    public RestfulResponse<Transaction> transfer(@RequestBody TransferRequest transfer){
        Transaction transferTransaction = this.walletService.transfer(transfer.getAmount(), transfer.getSourceWalletToken(), transfer.getTargetWalletToken());
